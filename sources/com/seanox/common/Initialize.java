...
public class Initialize implements Cloneable {
    ...
    public static Initialize parse(String text, boolean smart) {
        ...
        LinkedHashMap<String, StringBuffer> entries;
        String                              line;
        String                              section;
        String                              value;
        StringBuffer                        buffer;
        ...
        for (String key : entries.keySet()) {
            value = entries.get(key).toString().trim();
            if (!smart || !value.isEmpty())
                initialize.entries.put(key, Section.parse(value, smart));
        }
    ...
    /**
     *  TODO: R&uuml;ckgabe der angegebenen Section.
     ...
     *  Sektion, wenn ein g&uml;ltiger Schl&uuml;ssel angegeben wird.
     *  @param  key Name der Section
     *  @return die ermittelte Section, sonst {@code null} bzw. im
