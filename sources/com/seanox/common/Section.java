...
public class Section implements Cloneable {
    ...
    /**
     *  TODO: R&uuml;ckgabe vom Wert des Sch&uuml;ssels. Ist dieser nicht enthalten
     *  bzw. kann nicht ermittelt werden, liefert die Methode {@code null} und
     *  im Smart-Modus einen leeren Wert, wenn ein g&uml;ltiger Schl&uuml;ssel
     *  angegeben wird. Da im Smart-Modus leere Schl&uuml;ssel automatisch
     *  bereinigt werden, wird der erstellte Schl&uuml;ssel mit seinem leeren
     *  Standardwert nicht in der Section eingetragen. 
     *  @param  key Name des Sch&uuml;ssels
     *  @return der Wert des Sch&uuml;ssels, sonst {@code null} und im
     ...
     *  Wert, sonst {@code null}, bzw. im Smart-Modus einen leeren Wert, wenn
     *  ein g&uml;ltiger Schl&uuml;ssel angegeben wird. Da im Smart-Modus leere
     *  Schl&uuml;ssel automatisch bereinigt werden, wird der erstellte
    ...
    public synchronized String get(String key, String alternate) {
        ...
        if (key == null
                || key.isEmpty())
            value = null;
        else value = this.entries.get(key);
